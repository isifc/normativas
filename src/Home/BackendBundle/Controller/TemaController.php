...
use Home\BackendBundle\Entity\Tema;
use Home\BackendBundle\Form\TemaType;
use Home\BackendBundle\Form\TemaFilterType;
...
class TemaController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('HomeBackendBundle:Tema')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('TemaControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('TemaControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('TemaControllerFilter')) {
                $filterData = $session->get('TemaControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new TemaFilterType(), $filterData, array(
            'action' => $this->generateUrl('admin_tema'),
            'method' => 'GET',
        ));
     ...
     *
     * @Route("/", name="admin_tema_create")
     * @Method("POST")
     * @Template("HomeBackendBundle:Tema:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('admin_tema_new')
                    : $this->generateUrl('admin_tema_show', array('id' => $entity->getId()));
    ...
    */
    private function createCreateForm(Tema $entity)
    {
        $form = $this->createForm(new TemaType(), $entity, array(
            'action' => $this->generateUrl('admin_tema_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HomeBackendBundle:Tema')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="admin_tema_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new TemaType(), $entity, array(
            'action' => $this->generateUrl('admin_tema_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_tema_update")
     * @Method("PUT")
     * @Template("HomeBackendBundle:Tema:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('admin_tema_new')
                        : $this->generateUrl('admin_tema_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
     ...
     *
     * @Route("/{id}", name="admin_tema_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_tema'));
    }
    ...
    private function createDeleteForm($id)
    {
        ...
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_tema_delete', array('id' => $id)))
            ->setMethod('DELETE')
