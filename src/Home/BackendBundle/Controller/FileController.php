...
use Home\BackendBundle\Entity\File;
use Home\BackendBundle\Form\FileType;
use Home\BackendBundle\Form\FileFilterType;
...
class FileController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('HomeBackendBundle:File')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('FileControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('FileControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('FileControllerFilter')) {
                $filterData = $session->get('FileControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new FileFilterType(), $filterData, array(
            'action' => $this->generateUrl('file'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("HomeBackendBundle:File:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('file_new')
                    : $this->generateUrl('file_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HomeBackendBundle:File')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HomeBackendBundle:File:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('file_new')
                        : $this->generateUrl('file_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
