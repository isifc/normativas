...
class DisposicionController extends Controller
{
    ...
    */
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('admin_disposicion_new')
                    : $this->generateUrl('admin_disposicion_show', array('id' => $entity->getId()));
    ...
    /**
    * Creates a form to create a Disposicion entity.
    *
    * @param Disposicion $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createCreateForm(Disposicion $entity)
    {
        $form = $this->createForm(new DisposicionType(), $entity, array(
            'action' => $this->generateUrl('admin_disposicion_create'),
            'method' => 'POST',
        ));
    ...
    /**
     * Displays a form to create a new Disposicion entity.
     *
     * @Route("/new", name="admin_disposicion_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_disposicion_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Disposicion entity.');
        }
    ...
    /**
     * Displays a form to edit an existing Disposicion entity.
     *
     * @Route("/{id}/edit", name="admin_disposicion_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    /**
    * Creates a form to edit a Disposicion entity.
    *
    * @param Disposicion $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(Disposicion $entity)
    {
        $form = $this->createForm(new DisposicionType(), $entity, array(
            'action' => $this->generateUrl('admin_disposicion_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    /**
     * Edits an existing Disposicion entity.
     *
     * @Route("/{id}", name="admin_disposicion_update")
     * @Method("PUT")
     * @Template("HomeBackendBundle:Disposicion:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('admin_disposicion_new')
                        : $this->generateUrl('admin_disposicion_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
    ...
    /**
     * Deletes a Disposicion entity.
     *
     * @Route("/{id}", name="admin_disposicion_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_disposicion'));
    }

    /**
     * Creates a form to delete a Disposicion entity by id.
     *
    ...
    private function createDeleteForm($id)
    {
        ...
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_disposicion_delete', array('id' => $id)))
            ->setMethod('DELETE')
